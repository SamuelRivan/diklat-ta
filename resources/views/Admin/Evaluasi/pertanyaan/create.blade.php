{{-- Admin: View Tambah Pertanyaan Baru --}}
@extends('layouts.app')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="card-title mb-2">
                        <i class="fas fa-plus-circle me-3"></i>Tambah Pertanyaan
                    </h1>
                            ...
                            <div class="col-md-4">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="jenis" id="jenis_pilihan_ganda" value="pilihan_ganda" 
                                           {{ old('jenis') == 'pilihan_ganda' ? 'checked' : '' }} checked>
                            ...
                            <div class="col-md-4">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="jenis" id="jenis_pertanyaan_singkat" value="pertanyaan_singkat"
                                           {{ old('jenis') == 'pertanyaan_singkat' ? 'checked' : '' }}>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function enableOpsiInputs() {
            opsiContainer.querySelectorAll('input, textarea, select').forEach(el => {
                el.disabled = false;
                // restore required for opsi[] fields
        ...
        function disableOpsiInputs() {
            opsiContainer.querySelectorAll('input, textarea, select').forEach(el => {
                el.disabled = true;
                // remove required so browser won't block submission
                if (el.name && el.name.includes('opsi')) {
                    el.required = false;
                }
            });
        ...
        tambahOpsiBtn.addEventListener('click', function() {
            ...
            // If opsi section is currently hidden, disable inputs on the newly added option
            if (opsiSection.style.display === 'none') {
                newOpsi.querySelectorAll('input, textarea, select').forEach(el => el.disabled = true);
            }
