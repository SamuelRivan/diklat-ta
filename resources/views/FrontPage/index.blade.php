            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="100">
              <div class="icon-box">
                <center>
                  ...
                  <h4 class="title">
                    <a onclick="window.location='{{ route('BrosurPelatihan.usulan') }}'">BROSUR PELATIHAN</a>
                  </h4>
                </center>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="200">
              <div class="icon-box">
                <center>
                  ...
                  <h4 class="title"><a onclick="window.location='{{ route('EkatalogPelatihan.ekatalog') }}'">E-KATALOG
                      PELATIHAN</a></h4>
                </center>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="400">
              <div class="icon-box">
                <center>
                  ...
                  <h4 class="title"><a onclick="window.location='{{ route('DirektoriPelatihan.direktori') }}'">DIREKTORY
                      PELATIHAN</a></h4>
                </center>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="400">
              <div class="icon-box">
                <center>
                  ...
                  <h4 class="title">
                    <a onclick="window.location='{{ route('akpk.index') }}'">PERENCANAAN-AKPK</a>
                </h4>                
                </center>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="400">
              <div class="icon-box">
                <center>
                  ...
                  <h4 class="title"><a onclick="window.location='{{ route('EvaluasiPasca.homepage') }}';">EVALUASI PASCA
                      DIKLAT</a></h4>
              </div>
            </div>
            <!--End Icon Box -->
