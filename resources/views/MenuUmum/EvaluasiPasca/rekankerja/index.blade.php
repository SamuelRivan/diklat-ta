{{-- View Daftar Alumni untuk Dinilai Rekan Kerja --}}
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Evaluasi Alumni - Rekan Kerja</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">
                ...
                Evaluasi Alumni - Rekan Kerja
            </a>
            <div class="ms-auto">
                <span class="navbar-text me-3">
                    <i class="fas fa-user me-1"></i>
                    {{ $pegawai->nama }} (Rekan Kerja)
                </span>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text text-muted">
                            Selamat datang, <strong>{{ $pegawai->nama }}</strong>. Berikut adalah daftar alumni yang perlu Anda evaluasi sebagai rekan kerja.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card alumni-card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('evaluasi.rekankerja.kuesioner', $item->alumni_id) }}" 
